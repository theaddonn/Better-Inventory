...
void ShulkerRenderer::Render(MinecraftUIRenderContext* ctx, HoverRenderer* hoverRenderer, int index) {
	...
	// Draw the item icons ScreenContext& screenContext, ClientInstance& clientInstance, IMinecraftGame& minecraftGame
